...
### Added
- Added missing property "idAPIfootballv3" to "League" entity 
- Added missing property "intLoved" to "Venue" entity

### Deprecated
- Search players by team query is not supported anymore

## [1.5.18] - 2026-02-10

### Added
- Added missing property "strDeathLocation" to "Player" entity

## [1.5.17] - 2026-02-02

### Added
- Added missing property "strCutout" to "Timeline" entity

## [1.5.16] - 2026-01-20

### Added
- Added missing property "strCartoon" to "Love" entity
- Added missing property "strPlayerCartoon" to "Player" entity
...
### Added
- Added property "relevance" to "Player" entity for search endpoints
- Added properties "idHonour" and "idMilestone" to "Love" entity
- Added property "idHonour" to "Honour" entity

### Changed
- Marked several properties as nullable in "Player" entity

## [1.5.10] - 2025-03-10

### Added
- Added property "strPlayerPoster" to "Love" entity
- Added property "strPoster" to "Player" entity

## [1.5.9] - 2025-02-25

### Added
- Added properties "idTransferMkt", "idESPN" and "dateDied" to "Player" entity

## [1.5.8] - 2025-02-17

### Added
- Added property "strEventCountry" to "Television" entity
...
### Added
- Added property "idChannel" to "Love" entity

## [1.5.5] - 2024-08-26

### Added
- Added properties strEventThumb, strEventPoster, strEventBanner and strEventSquare to Television entity
- Added property "strLeagueBadge" to Event entity
- Added properties strTeamEquipment, strLeaguePoster and strLeagueTrophy to Love entity
...
### Added
- Added strVenueSponsor and strTimezone to Venue entity

## [1.5.1] - 2024-07-02

### Added
- Added BC property `strBadge` (previously `strTeamBadge`) to `Entry`/`Standing` entity
- Added BC property `strTeamAlternate` (previously `strAlternate`) to `Team` entity
